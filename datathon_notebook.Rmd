...
```{r}
data_final <- data_order_weight
# data_order_weight <- data_order_weight %>% ungroup()
# write_csv(x = data_order_weight, path = "C:/Users/willi/OneDrive/Documents/r-projects/MMA_datathon/data/data_final.csv")
```
...
data_numeric_only <- data_final %>% select_if(is.numeric)
